...
public class Crime {
    ...
    // 代码清单15-2 添加 mSuspect 成员变量（Crime.java） -- start1
    private String mSuspect;
    // 代码清单15-2 添加 mSuspect 成员变量（Crime.java） -- end1
    ...
    // 代码清单15-2 添加 mSuspect 成员变量（Crime.java） -- start2
    ...
    // 代码清单15-2 添加 mSuspect 成员变量（Crime.java） -- end2

    // 代码清单16-5 添加文件名获取方法（Crime.java） -- start
    public String getPhotoFilename() {
        return "IMG_" + getId().toString() + ".jpg";
    }
    // 代码清单16-5 添加文件名获取方法（Crime.java） -- end
}