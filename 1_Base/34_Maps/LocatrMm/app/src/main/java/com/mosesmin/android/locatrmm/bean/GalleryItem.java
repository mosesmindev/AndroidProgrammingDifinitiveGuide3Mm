package com.mosesmin.android.locatrmm.bean;
...
public class GalleryItem {
    ...
    // 代码清单34-5 添加经纬度属性（GalleryItem.java） -- 1start
    private double mLat;
    private double mLon;
    // 代码清单34-5 添加经纬度属性（GalleryItem.java） -- 1end
    ...
    // 代码清单34-5 添加经纬度属性（GalleryItem.java） -- 2start
    ...
    // 代码清单34-5 添加经纬度属性（GalleryItem.java） -- 2end
}