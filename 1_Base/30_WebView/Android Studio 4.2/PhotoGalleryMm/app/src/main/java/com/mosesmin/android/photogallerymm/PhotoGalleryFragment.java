...
public class PhotoGalleryFragment extends VisibleFragment {
    ...
    private class PhotoHolder extends RecyclerView.ViewHolder
            // 代码清单30-3 通过隐式intent实现网页浏览（PhotoGalleryFragment.java） -- 1 implements View.OnClickListener
            implements View.OnClickListener {
        // 代码清单26-1 更新 PhotoHolder （PhotoGalleryFragment.java）
        private ImageView mItemImageView;

        // 代码清单30-3 通过隐式intent实现网页浏览（PhotoGalleryFragment.java） -- 2
        ...
        public PhotoHolder(View itemView) {
            ...
            // 代码清单30-3 通过隐式intent实现网页浏览（PhotoGalleryFragment.java） -- 3
        ...
        /**
         * 代码清单30-3 通过隐式intent实现网页浏览（PhotoGalleryFragment.java） -- 4
         * @param v
         */
        @Override
        public void onClick(View v) {
            // 代码清单30-7 启动新建的activity（PhotoGalleryFragment.java） -- start
            //Intent i = new Intent(Intent.ACTION_VIEW, mGalleryItem.getPhotoPageUri());
            Intent i = PhotoPageActivity
                    .newIntent(getActivity(), mGalleryItem.getPhotoPageUri());
            // 代码清单30-7 启动新建的activity（PhotoGalleryFragment.java） -- end
            startActivity(i);
        }
    }
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder> {
        ...
        public void onBindViewHolder(PhotoHolder photoHolder, int position) {
            ...
            // 代码清单30-4 绑定 GalleryItem （PhotoGalleryFragment.java）
