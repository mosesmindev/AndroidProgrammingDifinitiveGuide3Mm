...
public class DatePiakcerFragment extends DialogFragment {
    ...
    public static final String EXTRA_DATE = "com.mosesmin.android.crimeintentmm.date";
    private static final String ARG_DATE = "date";
    private DatePicker mDatePicker;

    public static DatePiakcerFragment newInstance(Date date){
        Bundle args = new Bundle();
        args.putSerializable(ARG_DATE,date);
        DatePiakcerFragment fragment = new DatePiakcerFragment();
