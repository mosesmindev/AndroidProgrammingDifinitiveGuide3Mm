...
public class BeatBoxFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 代码清单21-18 调用 setRetainInstance(true) （BeatBoxFragment.java） -- 保留 fragment
        // fragment中的retainInstance方法可以确保 BeatBox 实例不被销毁   BeatBox不是可以序列化的对象
    ...
    /**
     * 代码清单21-17 释放 BeatBox （BeatBoxFragment.java） --释放音频
     */
    @Override
